"""
Django settings for PaymentWithStripe project.
...
SECRET_KEY = 'django-insecure-5=6^w1+q$^wrl4%n25_vpab$9pt9k_faw7u1@(1nynmhmy=t*8'
...
ROOT_URLCONF = 'PaymentWithStripe.urls'
...
WSGI_APPLICATION = 'PaymentWithStripe.wsgi.application'
